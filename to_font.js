...
(function () {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var in_path, fix_path, out_path, fs, SVGFixer, fix_options, glyph_map, files;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    in_path = (_a = process.argv[2]) !== null && _a !== void 0 ? _a : "char_glyphs";
                ...
                case 1:
                    ...
                    files.forEach(function (file, index) {
                        ...
                        var svg_path = fix_path + "/" + file;
                        var svg_glyph = fs.readFileSync(svg_path, 'utf-8').replace("0 0 136 120", "0 0 600 " + 600 / 136 * 120);
