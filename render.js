(() => {
    ...
    const columns_svg = Array.from({ length: column_num }, (_, index) => `    <g id="column${column_num - 1 - index}" stroke-width="0" transform="translate(${viewBox_min_x + 10 + (full_cell_width + 20 + config.column_spacing) * index}, ${config.viewBox_min_y + 10})">
${single_column_svg}
    </g>`).join("\n");
